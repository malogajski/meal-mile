            ...
            <li key="{{ $row->id }}" class="transition duration-200 ease-in-out transform {{ $row->is_purchased ? 'dark:bg-gray-600 bg-green-200 dark:text-gray-300' : 'dark:bg-gray-700 dark:text-white text-gray-700 bg-gray-200' }} p-2 flex items-center justify-between rounded-lg shadow">
                ...
                <div class="flex items-center space-x-3">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <div class="w-11 h-6 bg-gray-300 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 dark:bg-gray-500 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-lime-600"></div>
                    </label>
