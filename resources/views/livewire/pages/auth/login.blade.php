...
<div>
    ...
    <div class="flex flex-col items-center justify-between w-full mt-6">
        ...
        <a href="/auth/facebook/redirect" type="button" class="text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
        ...
        <a href="/auth/twitter/redirect" class="text-black bg-white hover:bg-gray-200 active:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-[#1da1f2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#1da1f2]/55 me-2 mb-2">
