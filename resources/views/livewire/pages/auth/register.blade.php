...
<div>
    <form wire:submit="register">
        <!-- Team -->
        <div class="mt-4">
            <x-input-label for="team_id" :value="__('Team Code (Optional)')"/>
            <x-text-input wire:model="team_code" id="team_id" class="block mt-1 w-full" type="text" name="team_id"/>
    ...
    <span class="[&>svg]:h-4 [&>svg]:w-4">
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 488 512">
        ...
        <!-- Facebook -->
        <a href="/auth/facebook/redirect" data-twe-ripple-init data-twe-ripple-color="light"
    ...
    <span class="[&>svg]:h-4 [&>svg]:w-4">
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 320 512">
        ...
        <!-- Github -->
        <a href="/auth/github/redirect" data-twe-ripple-init data-twe-ripple-color="light"
    ...
    <span class="[&>svg]:h-4 [&>svg]:w-4">
      <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512">
        ...
        <!-- X -->
        <a href="/auth/twitter/redirect" data-twe-ripple-init data-twe-ripple-color="light"
